# Dimension OS Documentation

This folder is the current documentation set. Older documents were archived under `docs/legacy/`.

## Start Here

- [STATUS.md](STATUS.md): exact current state and blockers.
- [GETTING_STARTED.md](GETTING_STARTED.md): commands for WSL/Nix, checks, and ISO build.
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md): VM/debug playbooks.
